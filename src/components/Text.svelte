<script context="module">
	export var text = [
		...
		"A quick zoom into Europe, and you can see the diversity of each of these zones. Amersterdam, Barcelona, Milan, and Istanbul all have very distinct climates, yet all live within the general classification of Temperate.<br><br> **NOTES: Zoom into Europe, show cities and labels",
		"On the other hand, cities oceans apart, have the same climate, and on average will have similar weather throughout the year. <br><br>Here we are looking at cities in the Temperate - No Dry Season, Hot Summer classification <br><br> ***NOTES add drop downlabel to filter the other classifications? ",
		"A recent study, led by climatologist Hylke Beck, used projected data from climate models along with the current Koppen Climate Classification to give a glimpse at what our world may look and feel like in 2070. <br><br>This project looks at 70 global cities, and tracks their classification from 2023 to 2070. And with climate change, your city isn't just getting hotter...it's beginning to resemble the climate of different cities.By moving cities into the future, while leaving others in their 2023 classification, we can start to imagine what the places we love may feel like in 2070… ",
		"WOOHOO"
	];
</script>
