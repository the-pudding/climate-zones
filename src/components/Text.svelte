<script context="module">
	export var text = [
		...
		`,
		`150 years ago, a German scientist by the name of Wladimir Koppen, attempted to bridge gap between climate and weather, and used vegetation growth to classify the world into 5 distinct climate zones: <br> <span style="color:rgba(249, 88, 88)">Arid</span>,<span style="color:rgba(88, 152, 249)">Tropical</span>,<span style="color:rgba(88, 249, 104)">Temperate</span>, <span style="color:rgba(178, 88, 249)">Cold</span>, <span style="">Polar</span>
